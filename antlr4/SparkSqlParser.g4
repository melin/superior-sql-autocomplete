...
windowFrame
    : frameType=RANGE startFb=frameBound
    | frameType=ROWS startFb=frameBound
    | frameType=RANGE BETWEEN startFb=frameBound AND endFb=frameBound
    | frameType=ROWS BETWEEN startFb=frameBound AND endFb=frameBound
    ;
