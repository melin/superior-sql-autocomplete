// Generated from antlr4/SparkSqlParser.g4 by ANTLR 4.9.0-SNAPSHOT
...
export interface SparkSqlParserListener extends ParseTreeListener {
	 ...
	 * labeled alternative in `SparkSqlParser.partitionField`.
	 * @param ctx the parse tree
	 */
	...
	/**
	 * Enter a parse tree produced by the `percentile`
	 * labeled alternative in `SparkSqlParser.primaryExpression`.
	 * @param ctx the parse tree
	 */
	enterPercentile?: (ctx: PercentileContext) => void;
	/**
	 * Exit a parse tree produced by the `percentile`
	 * labeled alternative in `SparkSqlParser.primaryExpression`.
	 * @param ctx the parse tree
	 */
